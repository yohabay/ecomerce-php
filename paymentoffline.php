...
.ordernow a{width: 200px;margin: 20px auto 0;background:orange;text-align: center;padding: 5px;font-size: 30px;display: block;bac$round: #ff0000;color: #fff;border-radius: 3px;}
.ordernow a:hover{
    background: blue;
}
</style>
